...
public:
    ...
    void asign(float xCor, float yCor){
        x = xCor;
        y = yCor;
    };
private:
...
goal Printerroom;
Printerroom.asign(2.2, 6.1);
Printerroom.x
*/
class moveToGoal{
    public:
        /*double B228 (double xGoal, double yGoal){
            xGoal = 1.181052;
            yGoal = 0.033761;
        }*/
        void PrinterRoom (double xGoal, double yGoal){
            xGoal = 2.200309;
            yGoal = 6.166436;
        }
        void TechnicRoom (double xGoal, double yGoal){
        ...
        void ButtonCallback(const kobuki_msgs::ButtonEvent::ConstPtr& msg){ 
            ...
            if (Pressed=true){
                switch (Button){
                    /*case 0:
                        moveToGoal::B228(xGoal, yGoal);
                    break;*/ 
                    case 1:
                        moveToGoal.PrinterRoom();
                    break;  
                    /*case 2: 
...
/* Initelizing ros */    
    ...
    ros::spinOnce();
    path_to_sounds = "/home/ros/git_ws/src/p1_b228/busroute/sounds/";
